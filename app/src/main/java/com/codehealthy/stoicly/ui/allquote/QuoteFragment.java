...
public class QuoteFragment extends com.codehealthy.stoicly.ui.allquote.BaseQuoteFragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        setUpToolbarTitle();
        quoteViewModel = ViewModelProviders.of(this).get(com.codehealthy.stoicly.ui.allquote.QuoteViewModel.class);
